...
class ThreadedTCPServer(socketserver.ThreadingMixIn, socketserver.TCPServer):
    def __init__(self, server_address, RequestHandlerClass, bind_and_activate: bool = True, msg_queue_ref=[]) -> None:
        ...
        self.RequestHandlerClass.msg_queue = msg_queue_ref  # pass msq_queue to sockethandler
...
class ThreadedTCPServerManager():
    ...
    def thread_init_and_run(self):
        server_thread = ThreadedTCPServer((HOST, PORT), SimpleSocketHandler, msg_queue_ref=self.msg_queue)
